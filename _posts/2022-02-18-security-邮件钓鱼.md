...
![](https://img2022.cnblogs.com/blog/2537202/202202/2537202-20220214160620661-1673016502.png)
...
url里面填写钓鱼邮件里面的超链接的URL，也就是受害者点击邮件模板里的链接后跳转到的页面。要是想让用户点击钓鱼邮件的链接之后跳转到自己设置的landing page里的钓鱼页面中，就要填写gophish所在服务器的IP，格式：`http://主机IP`，要是在自己本机部署的gophish，则可以直接填`http://127.0.0.1`。
